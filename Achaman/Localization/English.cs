...
namespace Achaman.Localization {
    public class English : ILanguage {
        private readonly Dictionary<string, string> translations = new Dictionary<string, string> {
            ...
            { "ManipulateAtmosphere", "Manipulate atmosphere (host-side) (DEPRECATED)" },
            { "ShipTemperature", "Ship Temperature (host-side) (DEPRECATED)" },
            { "ShipPressure", "Ship Pressure (host-side) (DEPRECATED)" },
            { "ShipOxygen", "Ship Oxygen (host-side) (DEPRECATED)" },
            { "NoShipDamage", "No Ship Damage (host-side) (DEPRECATED)" },
